...
export const messages = {
  en: {
    ...
    reserved: 'Someone is already checking out. You can still try; the reservation may clear.',
    ...
    railStepBody:
      'Looks like you may be in Argentina. Polar is the default worldwide. Mercado Pago Checkout Pro is optional here.',
  ...
  es: {
    ...
    reserved: 'Alguien ya está pagando. Igual podés intentar; la reserva puede liberarse.',
    ...
    railStepBody:
      'Parece que estás en Argentina. Polar es el default en todo el mundo. Mercado Pago Checkout Pro es opcional acá.',
    railPolar: 'Polar (default)',
