...
export const messages = {
  en: {
    ...
    railPayPalHintAr: 'From Argentina, PayPal usually asks you to open an account first.',
  ...
  es: {
    ...
    railPayPalHintAr: 'Desde Argentina, PayPal suele pedirte abrir una cuenta antes de pagar.',
